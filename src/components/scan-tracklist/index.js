...
export default function ScanTracklist() {
    ...
    const [ocrFileType, setOcrFileType] = React.useState(null);
                            ...
                            {!confirmTrackList && (
                                <div className="mt-3 flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-3 sm:space-y-0">
                                    ...
                                    <div className="flex flex-col items-start sm:items-end space-y-1">
                                        <label
                                            className="cursor-pointer inline-flex items-center space-x-2 rounded-lg border border-gray-300 bg-gray-100 px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-300 transition-colors"
